...
echo "   tmux new-window -n \"${TASK_NAME}\" \"cd worktree/${TASK_NAME} && PROJECT_ROOT=\$PROJECT_ROOT claude '../../.parallel-dev/tasks/${TASK_NAME}.md を読んで実装してください。完了したら .done ファイルを作成してください。'\""
echo ""
